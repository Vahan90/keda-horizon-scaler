...
const file_externalscaler_externalscaler_proto_rawDesc = "" +
	...
	"targetSize\x12(\n" +
	"\x0ftargetSizeFloat\x18\x03 \x01(\x01R\x0ftargetSizeFloat\"U\n" +
	"\x15GetMetricSpecResponse\x12<\n" +
	"\vmetricSpecs\x18\x01 \x03(\v2\x1a.externalscaler.MetricSpecR\vmetricSpecs\"~\n" +
	...
	"\x10metricValueFloat\x18\x03 \x01(\x01R\x10metricValueFloat\"U\n" +
	"\x12GetMetricsResponse\x12?\n" +
	"\fmetricValues\x18\x01 \x03(\v2\x1b.externalscaler.MetricValueR\fmetricValues2\xec\x02\n" +
	...
	"\n" +
	"GetMetrics\x12!.externalscaler.GetMetricsRequest\x1a\".externalscaler.GetMetricsResponse\"\x00B$Z\"keda-horizon-scaler/externalscalerb\x06proto3"
...
var file_externalscaler_externalscaler_proto_goTypes = []any{
	...
	(*MetricSpec)(nil),            // 2: externalscaler.MetricSpec
	(*GetMetricSpecResponse)(nil), // 3: externalscaler.GetMetricSpecResponse
	(*GetMetricsRequest)(nil),     // 4: externalscaler.GetMetricsRequest
	(*MetricValue)(nil),           // 5: externalscaler.MetricValue
	(*GetMetricsResponse)(nil),    // 6: externalscaler.GetMetricsResponse
...
var file_externalscaler_externalscaler_proto_depIdxs = []int32{
	...
	2, // 1: externalscaler.GetMetricSpecResponse.metricSpecs:type_name -> externalscaler.MetricSpec
	0, // 2: externalscaler.GetMetricsRequest.scaledObjectRef:type_name -> externalscaler.ScaledObjectRef
	5, // 3: externalscaler.GetMetricsResponse.metricValues:type_name -> externalscaler.MetricValue
	...
	3, // 10: externalscaler.ExternalScaler.GetMetricSpec:output_type -> externalscaler.GetMetricSpecResponse
	6, // 11: externalscaler.ExternalScaler.GetMetrics:output_type -> externalscaler.GetMetricsResponse
